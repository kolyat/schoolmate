webix.protoUI({
	...
	$init: function(config) {
		...
		html += config.mode == "document"
		    ? ("<div class='webix_ck_body'>"+editor+"</div>") : editor;
	...
	_require_ckeditor:function() {
		...
		var cdn = this.config.cdn || "../static/notebook/js";
	...
	_render_ckeditor: function() {
		...
		var editor = !window.DecoupledDocumentEditor
		    ? DecoupledEditor : DecoupledDocumentEditor;
